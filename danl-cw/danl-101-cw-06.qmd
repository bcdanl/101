...
DT::datatable(data.frame(
  Question = c('data.frame-variable',
               ...
               '!= (not-equal operator)',
               '| (or operator)'),
  Percentage = c(76.32, 69.44, 78.38, 76.47, 71.43)
))
...
- [This slide](https://bcdanl.github.io/101/danl-lec/danl-101-lec-11-2024-1001.html#/filter-observations-with-filter-4) and [Line 105-106 in this class R script slide](https://github.com/bcdanl/101-04-R/blob/master/danl-101-04-2024-1001.R) in Lecture 11 explain a not-equal operator, `!=` (not equal to).
