---
title: Lecture 3
subtitle: Sports Analytics; Business Intelligence
format:
  clean-revealjs:
...
# **Sports Analytics---Understanding Applications of Data Analytics** {background-color="#1c4982"}
...
<div style="text-align: center; width: 80%; margin: auto;">
  ...
  <p style="font-weight: bold;">Predicting Run or Pass in the Next Play</p>
</div>
...
## 3. Player Performance: The Case of Hockey
...
- Here, we instead use **machine learning** methods to analyze _how likely making a goal is associated with whether or not a player is on the ice_.
