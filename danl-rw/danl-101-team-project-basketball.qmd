...
# Data
The following lists data frames about NBA 2022-23 through 2024-25:
...
- `rank`: Player's ranking on the stats table (**Rk** from [Basketball Reference](https://www.basketball-reference.com/))
