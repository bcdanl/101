...
- **Phone**: (585) 245-5425
- **Class Websites**:
  - [GitHub Course Website](https://bcdanl.github.io)
  - [Brightspace Course Shell](http://brightspace.geneseo.edu)
...
<!-- This course offers a practical introduction to the data analytics process and methods. The goal is to help you unlock the potential of data analysis and enhance your ability to transform data into a powerful decision-making tool. You will develop foundational data analytics skills that will prepare you for a career or further studies in more advanced data analytics topics. The course covers: (1) an introduction to data analytics thinking, (2) exploratory data analysis through data wrangling and visualization, and (3) an introduction to data science and artificial intelligence (AI). Throughout the course, you will gain hands-on experience with the R programming language, along with its associated data analysis libraries and AI tools. -->
...
|:---:|:-------------:|:----------------------------------------------|:------|
| 1   | Aug 25–29    | Introduction to Data Analytics (Part 1)             |       |
| 2   | Sep 2–5      | Introduction to Data Analytics (Part 2); Generative AI (Part 1)             | Labor Day (Sep 1) |
| 3   | Sep 8–12     | Generative AI (Part 2)  |       |
| 4   | Sep 15–19    | R Basics for Data Analytics              |       |
| 5   | Sep 22–26    | R Basics for Data Analytics              |       |
...
- **Final Exam**: The School's schedule is available [here](https://www.geneseo.edu/sites/default/files/documents/2025.03.20%20202509%20Exam%20Schedule.pdf).
